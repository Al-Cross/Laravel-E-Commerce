...
@section ('content')
<create-product inline-template :categories="{{ $categories }}">
                           ...
                           <div class="form-group">
                                ...
                                <div v-for="(attribute, index) in attributes">
                                    ...
                                    <div v-for="value in attribute.values">
                                        <input type="checkbox" name="select_value" :value="value.id" v-model="product.selected" :disabled="!product.selected.includes(value.id) && product.selected.length == attributes.length">
                                        <label for="value" class="font-weight-bold">@{{ value.value }}</label>
                                    </div>
                                    <input type="checkbox" name="select_value" :value="attribute.id" v-model="toggleInput" :disabled="product.selected.length >= attributes.length"> Select New
                                    <div>
                                       <input type="text"
                            ...
                            <div class="form-group">
                                ...
                                <input type="quantity"
                                        ...
                                        required
                                >
                                <form-error v-if="errors.get('quantity')" :errors="errors">@{{ errors.get('quantity') }}</form-error>
                            </div>
                            <div class="form-group">
                            	<button type="button"
